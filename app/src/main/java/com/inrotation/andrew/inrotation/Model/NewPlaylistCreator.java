...
public class NewPlaylistCreator {
    ...
    public Playlist createNewPlaylist() {
        ...
        returnPlaylist.getSongListHead().setNext(new Song("Night Riders", "Major Lazer", "Peace Is The Mission", 3000, albumCovers, "spotify:track:2SKwCzTG3flzBqYQhGWj8J", true));
